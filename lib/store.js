...
// 선생님 색 팔레트 8색. 등록 순서대로 돌려 쓴다.
var PALETTE = ['#2f855a', '#2b6cb0', '#b7791f', '#9b2c2c', '#553c9a', '#0f766e', '#a15c07', '#9d174d'];
...
module.exports = {
  ...
  PALETTE: PALETTE, GRADES: GRADES, normGrade: normGrade, genId: genId,
